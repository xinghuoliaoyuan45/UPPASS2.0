...
@inject('rootStore')
@observer
class SelectSpaceScreen3 extends BaseScreen {
    @observable data = [];
    ...
    configData = async () => {
        ...
        param.append('transactionType', 1)
        ...
        return (
            <View style={{
                ...
                RkTheme.currentTheme.colors.gradualEnd]}
                    ...
                    <BaseHeader leftType='back' leftPress={this.goBack} title={ext('check_history')} />
                </LinearGradient>
            </View>
        );
    }
...
export default SelectSpaceScreen3;
